...
export class NewsItem extends Component {
    ...
    render() {
        let { title, description, imageUrl } = this.props;   // We are using destructuring concept...props mein hum object denge aur us object se title aur description waali keys ko pull karlo 
        return (
            <div className="my-3">
                <div className="card" style={{ width: "18rem" }}>
                    ...
                    <div className="card-body">
                        ...
                        <a href="/takingtonowhere" className="btn btn-sm btn-primary">Read More</a>
                    </div>
                </div>
            </div>
        )
